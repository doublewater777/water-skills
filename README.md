...
| [pr-builder](./skills/engineering/pr-builder/SKILL.md) | Own implementation from feature request to a verified, review-ready GitHub PR. |
| [pr-reviewer](./skills/engineering/pr-reviewer/SKILL.md) | Independently review a PR at its exact HEAD and return APPROVE or blocking changes without modifying code. |
